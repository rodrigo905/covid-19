# Projeto em React (COVID-19 pelo Mundo)

Este projeto é um site feito com React para mostrar dados da COVID-19 pelo mundo. O projeto foi proposto no bootcamp da Carrefour na Dio.\
...
A seguir são informações geradas pelo proprio React:
